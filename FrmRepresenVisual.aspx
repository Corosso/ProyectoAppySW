<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FrmRepresenVisual.aspx.cs" Inherits="proyectoindicadores2.FrmRepresenVisual" %>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2 class="miEstilo">Gestión <b>Representaciones Visuales</b></h2>
                            </div>
                            <div class="col-sm-6">
                                <a href="#crudModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Gestión Representaciones Visuales</span></a>                        
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><% Response.Write(arregloRepresenVisual[i].Id); %></td>
                                <td><% Response.Write(arregloRepresenVisual[i].Nombre); %></td>
                                <td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                        <div class="modal-header">                        
                            <h4 class="modal-title">Representaciones Visuales</h4>
