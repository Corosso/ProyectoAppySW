<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmUsuario.aspx.cs" Inherits="proyectoIndicadoresWEB1.FrmUsuario" %>
							...
							<table class="table table-striped table-hover">
								...
								%>
									<tr>
                                        ...
                                        <td><%Response.Write(arregloUsuario[i].Email); %></td>
										<td><%Response.Write(arregloUsuario[i].Contrasena); %></td>
										<td>
