<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FrmFuente.aspx.cs" Inherits="proyectoindicadores2.FrmFuente" %>
				...
				<div class="table-wrapper">
					<div class="table-title">
						<div class="row">
							...
							<div class="col-sm-6">
								<a href="#crudModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Gestión Fuentes</span></a>						
							</div>
						</div>
					</div>
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><% Response.Write(arregloFuentes[i].Id); %></td>
								<td><% Response.Write(arregloFuentes[i].Nombre); %></td>
								<td>
						...
						<div class="modal-body">
							...
							<div class="container">
								...
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab" href="#idfuente">Fuente</a>
									</li>
								</ul>

								<!-- Tab panes -->
								<div class="tab-content">
									<div id="idfuente" class="container tab-pane active"><br>
